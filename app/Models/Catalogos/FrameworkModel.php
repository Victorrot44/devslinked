...
class FrameworkModel extends Model{
  ...
  protected $primaryKey = 'frameworkId';
  ...
  protected $allowedFields = ['framework','frameworkProgrammingLanguageId'];
  ...
  public function allRecords() {
    return $this->select('framework.frameworkId, framework.framework, programmingLanguage.programmingLanguage')
                ->join('programmingLanguage', 'programmingLanguage.programmingLanguageId = framework.frameworkProgrammingLanguageId')
                ->findAll();
  }
